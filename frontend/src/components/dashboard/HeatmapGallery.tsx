...
export function HeatmapGallery() {
  ...
  const currentSrc = `/artifacts/analysis/near_miss_heatmap_${strictness}_${filtered ? "filtered" : "full"}.png`;
  const currentTitle = `Near-Miss Heatmap (${strictness}, ${filtered ? "Filtered" : "Full"})`;
