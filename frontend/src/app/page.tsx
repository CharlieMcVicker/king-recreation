  ...
  const metrics = [
    {
      ...
      total: coverage.strict_full["0"] + coverage.strict_full["1"] + coverage.strict_full["2+"],
    ...
    },
    {
      ...
      total: coverage.strict_ending["0"] + coverage.strict_ending["1"] + coverage.strict_ending["2+"],
    ...
    },
    {
      ...
      total: coverage.loose_full["0"] + coverage.loose_full["1"] + coverage.loose_full["2+"],
    ...
    },
    {
      ...
      total: coverage.loose_ending["0"] + coverage.loose_ending["1"] + coverage.loose_ending["2+"],
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 dark:text-zinc-400">High-level insights into linguistic verb classification.</p>
      </div>

      {/* Metrics Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {metrics.map((metric) => (
          <div key={metric.label} className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-gray-200 dark:border-zinc-800 shadow-sm">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {charts.map((chart) => (
            <div key={chart.title} className="bg-white dark:bg-zinc-900 p-4 rounded-xl border border-gray-200 dark:border-zinc-800 shadow-sm">
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
                {matchCounts.slice(0, 10).map((row: any) => (
                  <tr key={row.class} className="hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors">
                    <td className="px-6 py-4 font-semibold text-indigo-600 dark:text-indigo-400">{row.class}</td>
