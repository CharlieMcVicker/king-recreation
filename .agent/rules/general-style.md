...
## Project-scope markdown documents

Often in the course of a project, markdown documents are created to scope or report on a particular issue or new feature. These files should not be long lived, or committed to source control. Instead, relevant information should make it into long lived documentation (`README.md` or `docs/`) before changes are checked in.
