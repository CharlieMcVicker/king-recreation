---
id: doc-6
title: Preprocessing Specifications
type: specification
...
1. **CED Data**: [ced_data_original.csv](../../../../data/ced_data_original.csv). This is the default source.
2. **Cherokee Nation Dictionary (CND)**: [cherokee_nation_dictionary.csv](../../../../data/cherokee_nation_dictionary.csv). Used when the `--new-source` flag is provided. This source groups multiple rows by "No." and prioritizes "animate" or "3rd person object" forms where multiple variations exist for a single slot.

---

## 2. Normalization Rules

Preprocessing involves standardizing the input text via rules implemented in [preprocess_ced/__init__.py](../../../../dictionary_pipeline/phases/preprocess_ced/__init__.py):
