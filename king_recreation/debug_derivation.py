                    ...
                    for d in [True, False]:
                        ...
                        if all(stems for stems in possible_stems.values()):
                            ...
                            if valid_present_stems:
                                ...
                                initials = {fn: set(s[0] for s in stems if s) for fn, stems in possible_stems.items()}
                ...
                for t in [True, False]:
                    for p in [True, False]:
                        for d in [True, False]:
                            ...
                            if can_derive:
                                working_configs += 1
        print(f"Form '{fn}' ({forms[fn]}) can be derived in {working_configs}/32 configurations.")
