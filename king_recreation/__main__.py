...
def main():
    ...
    print("\n[1/7] Preprocessing CED Data...")
    process_cn_dict("data/cherokee_nation_dictionary.csv", "artifacts/data/corpus.csv")

    print("\n[2/7] Classifying Verbs and Stripping Endings...")
    classify_verbs(args.classes)

    print("\n[3/7] Deriving Roots from Stripped Corpus...")
    derive_stems()

    print("\n[4/7] Reconstructing from Roots...")
    reconstruct_from_roots(args.classes)

    print("\n[5/7] Analyzing Middle Voice Connections...")
