...
def _matches(candidate_row: dict[str, Any], config_row: dict[str, Any]) -> bool:
...
def main() -> None:
    ...
    inf_eventful_by_cid: dict[str, list[dict[str, Any]]] = {}
    ...
    unmatched: list[str] = []
    matched: dict[str, dict[str, Any]] = {}  # corpus_id -> matched candidate row
