...
from king_recreation.word_spec import Aspect, WordSpec
...
def test_reconstruct_spec():
    ...
    spec = WordSpec(aspect=Aspect.PRESENT, set_name="1st Set A", stative=False)
    ...
    spec = WordSpec(aspect=Aspect.PERFECTIVE, set_name="3pl Set B", stative=False)
    forms = engine.reconstruct_spec(verb, spec)
