...
class TestHMetathesis(unittest.TestCase):
    ...
    def test_derivation_singing(self):
        ...
        self.assertTrue(
            any(
                "ahnoki" in d.stems.get("present", "").split(";")
                and d.set_type == "Set A"
    ...
    def test_derivation_mingling(self):
        ...
        self.assertTrue(
            any(
                "ehlatitoh" in d.stems.get("present", "").split(";")
                and d.set_type == "Set A"
                for d in derivations
            )
        )
    ...
    def test_derivation_breathing(self):
        ...
        derivations = self.deriver.derive_row(row)
        print(
            f"Breathing A Derivations: {[(d.set_type, d.stems) for d in derivations]}"
        )
        self.assertTrue(
            any(
                "ahwolate" in d.stems.get("present", "").split(";")
                and d.set_type == "Set A"
                for d in derivations
            )
        )
    ...
    def test_derivation_mingling_set_b(self):
        ...
        self.assertTrue(
            any(
                "ahwelatitoh" in d.stems.get("present", "").split(";")
                and d.set_type == "Set B"
                for d in derivations
            )
        )
